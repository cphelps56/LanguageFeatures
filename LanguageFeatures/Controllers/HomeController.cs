...
namespace LanguageFeatures.Controllers
{
    public class HomeController : Controller
    {
        ...
        public string Index()
        {
            return "Navigate to a URL to show an example page";
        }
        ...
        {
            // create and popluate shopping cart
        ...
        public ViewResult CreateAnonArray()
        {
            ...
            {
                res.Append(item.Name).Append(" ");
            }

            return View("Result", (object)res.ToString());
        }
        ...
        public ViewResult FindProducts()
        {
            ...
            {
                res.AppendFormat("Price: {0} ", p.Price);
            }
            return View("Result", (object)res.ToString());
        }
        ...
        public ViewResult SumProducts()
        {
            ...
            var res = products.Sum(e => e.Price);

            products[2] = new Product { Name = "Stadium", Price = 79500m };

            return View("Result", (object)String.Format("Sum: {0:c}", res));
        }
    }
}